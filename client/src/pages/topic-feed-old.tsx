...
export default function TopicFeed() {
  ...
  // Always initialize smart feed for community posts (even if topic is invalid)
          ...
          {/* Tab Headers */}
              <div className="flex border-b border-gray-200 dark:border-gray-700">
                ...
                >
                  ...
                  <span className="text-sm bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300 px-3 py-1 rounded-full font-medium -ml-[2px] mr-[5px]">
                    {userPosts.length}
                  </span>
                </button>
              </div>
